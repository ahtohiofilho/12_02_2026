...
from ..datasets.sw import NOUNS, ADJ, TOPONYMS
...
class SwahiliGenerator:
    ...
    def province(self, ctx: NamingContext | None = None) -> str:
        ...
        pattern = wchoice(
            ...
            [
                "NOUN_ADJ",          # Mlima Mkuu
                "NOUN_TOPONYM",      # Mto Tumaini
                "TOPONYM_NOUN",      # Tumaini Mto (raro)
                "NOUN_ADJ_TOPONYM",  # Msitu Mkubwa Amani
                "ADJ_NOUN",          # Mkuu Mlima (raro)
            ],
            [45, 35, 6, 10, 4],
        )
